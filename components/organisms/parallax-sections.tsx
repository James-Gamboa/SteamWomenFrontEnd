...
export function ParallaxSections() {
  useEffect(() => {
    ...
    gsap.utils.toArray<HTMLElement>('section.parallax-section').forEach((section, i) => {
        ...
        >
          ...
          {i === 0 ? (
            <div className="text-center max-w-4xl mx-auto px-4">
              ...
              <h2 className="mb-4 font-medium text-white" style={{fontSize: '48px', lineHeight: '65px', fontFamily: 'DM Sans, sans-serif', fontWeight: 500}}>Impulsando mujeres en STEAM</h2>
              <p className="mb-8 max-w-2xl mx-auto leading-relaxed text-white" style={{fontSize: '18px', lineHeight: '28px', fontFamily: 'DM Sans, sans-serif', fontWeight: 400}}>
