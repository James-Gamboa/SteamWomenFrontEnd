...
export function Sidebar({ open, setOpen, onLogout }: SidebarProps) {
  ...
  const FixedSidebar = (
    <aside className="hidden md:flex w-64 bg-white dark:bg-[#1A1F2C] border-r border-gray-100 dark:border-gray-800 shadow-md flex-col py-0 min-h-screen">
      {/* Header del sidebar */}
      <div className="flex flex-col items-center gap-2 py-8 px-4 bg-[#F1F0FB] dark:bg-[#232347] border-b border-gray-100 dark:border-gray-800">
        <span className="text-3xl font-extrabold text-[#8B5CF6] tracking-wide">STEAMWomen</span>
        {user && (
